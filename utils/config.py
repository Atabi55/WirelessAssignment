...
SIM_TIME = 10 * 1e6  # us, total simulation time, run your final simulations with at least 1000 seconds
NUMBER_OF_NODES = 10  # number of drones in the network
STATIC_CASE = 0
...
# ---------- hardware parameters of drone (rotary-wing) -----------# # No need to change, except the INITIAL_ENERGY
...
INITIAL_ENERGY = 100 * 1e3  # in joule (This is the battery lifetime for the drone, you can change)
ENERGY_THRESHOLD = 2000  # in joule

# ----------------------- radio parameters ----------------------- # # No need to change
...
# ---------------------- packet parameters ----------------------- # # No need to change
...
# ---------------------- physical layer -------------------------- # # No need to change
...
# --------------------- mac layer parameters --------------------- # # No need to change
